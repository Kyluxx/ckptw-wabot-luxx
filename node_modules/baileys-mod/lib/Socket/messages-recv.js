...
const makeMessagesRecvSocket = (config) => {
    ...
    const handleReceipt = async (node) => {
        ...
        const participant = fromMe ? (0, WABinary_1.jidNormalizedUser)((_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id) : isLid ? attrs.participant_pn : attrs.participant;
        const key = {
            remoteJid,
            id: '',
            fromMe,
    ...
    const handleNotification = async (node) => {
        ...
        const participant = fromMe ? (0, WABinary_1.jidNormalizedUser)((_c = authState.creds.me) === null || _c === void 0 ? void 0 : _c.id) : isLid ? node.attrs.participant_pn : node.attrs.participant;
        if (shouldIgnoreJid(remoteJid) && remoteJid !== '@s.whatsapp.net') {
