...
class MessageCollector extends Collector_1.Collector {
    ...
    _collect(msg) {
        ...
        if (!msg.key.fromMe && this.jid === msg.key.remoteJid && (content === null || content === void 0 ? void 0 : content.length)) {
            this.received++;
            let sender = (0, Functions_1.getSender)(msg, this.clientReq.self.core);
            return Object.assign(Object.assign({}, msg), {
                jid: msg.key.remoteJid,
                decodedJid: msg.key.remoteJid ? (0, Functions_1.decodeJid)(msg.key.remoteJid) : null,
                sender,
                decodedSender: sender ? (0, Functions_1.decodeJid)(sender) : null,
                content
            });
        } else {
            return null;
