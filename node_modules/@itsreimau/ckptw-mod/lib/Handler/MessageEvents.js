...
const ExtractEventsContent_1 = __importDefault(require("./ExtractEventsContent"));
const emitPollCreation = (m, ev, self, core) => __awaiter(void 0, void 0, void 0, function*() {
    let used = (0, ExtractEventsContent_1.default)(m, MessageType_1.MessageType.pollCreationMessage);
    ...
    ev === null || ev === void 0 ? void 0 : ev.emit(Events_1.Events.Poll, m, new Ctx_1.Ctx({
        used,
        args: [],
        self: self,
        client: core
...
const emitPollUpdate = (m, ev, self, core) => __awaiter(void 0, void 0, void 0, function*() {
    let used = (0, ExtractEventsContent_1.default)(m, MessageType_1.MessageType.pollUpdateMessage);
    ev === null || ev === void 0 ? void 0 : ev.emit(Events_1.Events.PollVote, m, new Ctx_1.Ctx({
        used,
        args: [],
        self: self,
        client: core
...
const emitReaction = (m, ev, self, core) => __awaiter(void 0, void 0, void 0, function*() {
    let used = (0, ExtractEventsContent_1.default)(m, MessageType_1.MessageType.reactionMessage);
    ev.emit(Events_1.Events.Reactions, m, new Ctx_1.Ctx({
        used,
        args: [],
        self: self,
        client: core
