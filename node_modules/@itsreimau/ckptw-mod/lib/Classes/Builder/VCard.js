...
class VCardBuilder {
    ...
    setFullName(fullName) {
        if (!fullName)
            throw new Error("[ckptw-mod] vcard builder need full name");
        this.fullName = fullName;
        return this;
    }
    setOrg(organizationName) {
        if (!organizationName)
            throw new Error("[ckptw-mod] vcard builder need organization name");
        this.org = organizationName;
        return this;
    }
    setNumber(number) {
        if (!number)
            throw new Error("[ckptw-mod] vcard builder need number");
        this.number = number;
        return this;
    }
    build() {
