...
class GroupData {
    ...
    name() {
        return __awaiter(this, void 0, void 0, function*() {
            return yield this.getMetadata("subject");
        });
    }
    description() {
        return __awaiter(this, void 0, void 0, function*() {
            return yield this.getMetadata("desc");
        });
    }
    owner() {
        return __awaiter(this, void 0, void 0, function*() {
            return yield this.getMetadata("owner");
        });
    }
    isAdmin(jid) {
        return __awaiter(this, void 0, void 0, function*() {
            let members = yield this.members();
            let check = members.filter((x) => (0, Functions_1.decodeJid)(x.id) === (0, Functions_1.decodeJid)(jid) && (x.admin === "admin" || x.admin === "superadmin"));
            return check.length > 0;
        });
    }
    isSenderAdmin() {
        return __awaiter(this, void 0, void 0, function*() {
            return yield this.isAdmin(this.ctx.sender.decodedJid);
        });
    }
    isBotAdmin() {
        return __awaiter(this, void 0, void 0, function*() {
            return yield this.isAdmin(this.ctx.me.decodedId);
        });
    }
