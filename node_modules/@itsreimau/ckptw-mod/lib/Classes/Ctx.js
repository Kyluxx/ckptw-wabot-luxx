...
const baileys_1 = require("baileys-mod");
...
class Ctx {
    ...
    get msg() {
        return Object.assign(Object.assign({}, this._msg), {
            media: {
    ...
    reply(content, options = {}) {
        return __awaiter(this, void 0, void 0, function*() {
            ...
            return this.sendMessage(this.id, content, Object.assign({
                quoted: this._msg
            }, options));
        });
    }
    replyWithJid(jid, content, options = {}) {
        return __awaiter(this, void 0, void 0, function*() {
            return this.sendMessage(jid, content, Object.assign({
                quoted: this._msg
            }, options));
        });
    }
    ...
    MessageCollector(args = {
        ...
        return new MessageCollector_1.MessageCollector({
            self: this._self,
            msg: this._msg
        }, args);
    }
    ...
    getMediaMessage(msg, type) {
        return __awaiter(this, void 0, void 0, function*() {
            try {
                let buffer = yield(0, baileys_1.downloadMediaMessage)(msg, type, {}, {
    ...
    get quoted() {
        ...
        return Object.assign(Object.assign({}, quotedMessage), {
            senderJid: msgContext === null || msgContext === void 0 ? void 0 : msgContext.participant,
            decodedSenderJid: (0, Functions_1.decodeJid)(msgContext === null || msgContext === void 0 ? void 0 : msgContext.participant),
            media: {
                ...
                for (let i = 0; i < matchMention.length; i++) {
                    if (matchMention[i].match(/^@\d/gm)) {
                        ...
                        if ((_b = contentReal.contextInfo) === null || _b === void 0 ? void 0 : _b.mentionedJid) {
                            ...
                            contentReal.contextInfo = Object.assign(Object.assign({}, contentReal.contextInfo), {
                                mentionedJid: []
                            });
    ...
    getPushname(jid) {
        return this._self.pushNames[jid ? jid : this._msg.key.remoteJid];
    }
}
exports.Ctx = Ctx;